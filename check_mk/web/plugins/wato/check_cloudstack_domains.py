...
register_check_parameters(
    ...
    "check_cloudstack_domains",
    _("Cloudstack Domain Resources"),
    Dictionary(
        elements=[
            ("global",
                 Dictionary(
                ...
                help = _("Global parameters for cloudstack domains"),
                ),
            ),
            ("custom",
             ListOf(
                    ...
                    elements = [
                        ("name",
                         TextAscii(
                             ...
                             help=_("Add the name of the domain"),
                         ),
                         ),
                         ("cpu",
                          Tuple(
